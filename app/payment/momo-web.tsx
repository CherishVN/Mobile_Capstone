...
import {
  consumePendingMoMoUrl,
  tryCompleteMoMoWebViewReturn,
} from '@/lib/momo-in-app'
import { resolveIntentUrlForWebView } from '@/lib/vnpay-webview-nav'
import { COLORS, SIZES, FONTS } from '@/constants/theme'

/** User‑agent hợp lệ để cổng MoMo không chặn WebView. */
...
export default function MoMoWebScreen() {
  ...
  const tryReturn = useCallback((url: string) => {
    ...
    if (!tryCompleteMoMoWebViewReturn(url)) return false
